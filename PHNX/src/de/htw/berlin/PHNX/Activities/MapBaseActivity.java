...
//
//import de.htw.berlin.PHNX.Map.MapApplication;
//
///**
// * Code common to most activities in the Samples app.
// */
//public abstract class MapBaseActivity extends MapViewerTemplateActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
//
...
//		TileRendererLayer tileRendererLayer = de.htw.berlin.PHNX.Map.AndroidUtil.createTileRendererLayer(this.tileCaches.get(0),
...
//		boolean threaded = sharedPreferences.getBoolean(MapApplication.SETTING_TILECACHE_THREADING, true);
//		int queueSize = Integer.parseInt(sharedPreferences.getString(MapApplication.SETTING_TILECACHE_QUEUESIZE, "4"));
//
...
//								MapBaseActivity.this.mapView.getModel().mapViewPosition.getZoomLevelMin());
//
//                        MapBaseActivity.this.mapView.getModel().mapViewPosition.setMapPosition(
...
//			MapViewPosition currentPosition = MapBaseActivity.this.mapView.getModel().mapViewPosition;
...
//			zoomlevel.setProgress(MapBaseActivity.this.mapView.getModel().mapViewPosition.getZoomLevel()
...
//		if (MapApplication.SETTING_SCALE.equals(key)) {
//			this.mapView.getModel().displayModel.setUserScaleFactor(DisplayModel.getDefaultUserScaleFactor());
//			Log.d(MapApplication.TAG, "Tilesize now " + this.mapView.getModel().displayModel.getTileSize());
//			de.htw.berlin.PHNX.Map.AndroidUtil.restartActivity(this);
//		}
//		if (MapApplication.SETTING_TEXTWIDTH.equals(key)) {
//			de.htw.berlin.PHNX.Map.AndroidUtil.restartActivity(this);
//		}
//		if (MapApplication.SETTING_TILECACHE_QUEUESIZE.equals(key) || MapApplication.SETTING_TILECACHE_THREADING.equals(key)) {
//			de.htw.berlin.PHNX.Map.AndroidUtil.restartActivity(this);
//		}
//		if (SETTING_SCALEBAR.equals(key)) {
//			setMapScaleBar();
//		}
//		if (MapApplication.SETTING_DEBUG_TIMING.equals(key)) {
//			MapWorker.DEBUG_TIMING = preferences.getBoolean(MapApplication.SETTING_DEBUG_TIMING, false);
//		}
//		if (MapApplication.SETTING_WAYFILTERING_DISTANCE.equals(key) ||
//				MapApplication.SETTING_WAYFILTERING.equals(key)) {
//			MapDatabase.wayFilterEnabled = preferences.getBoolean(MapApplication.SETTING_WAYFILTERING, true);
//			if (MapDatabase.wayFilterEnabled) {
//				MapDatabase.wayFilterDistance = Integer.parseInt(preferences.getString(MapApplication.SETTING_WAYFILTERING_DISTANCE, "20"));
//			}
//		}
//	}
//
...
//			de.htw.berlin.PHNX.Map.AndroidUtil.setMapScaleBar(this.mapView, null, null);
//		} else {
//			if (SETTING_SCALEBAR_BOTH.equals(value)) {
//                de.htw.berlin.PHNX.Map.AndroidUtil.setMapScaleBar(this.mapView, MetricUnitAdapter.INSTANCE, ImperialUnitAdapter.INSTANCE);
//			} else if (SETTING_SCALEBAR_METRIC.equals(value)) {
//                de.htw.berlin.PHNX.Map.AndroidUtil.setMapScaleBar(this.mapView, MetricUnitAdapter.INSTANCE, null);
//			} else if (SETTING_SCALEBAR_IMPERIAL.equals(value)) {
//                de.htw.berlin.PHNX.Map.AndroidUtil.setMapScaleBar(this.mapView, ImperialUnitAdapter.INSTANCE, null);
//			} else if (SETTING_SCALEBAR_NAUTICAL.equals(value)) {
//                de.htw.berlin.PHNX.Map.AndroidUtil.setMapScaleBar(this.mapView, NauticalUnitAdapter.INSTANCE, null);
//			}
//		}
//	}
//
...
//		mapView.getModel().displayModel.setMaxTextWidthFactor(Float.valueOf(sharedPreferences.getString(MapApplication.SETTING_TEXTWIDTH, "0.7")));
//	}
//
//}
