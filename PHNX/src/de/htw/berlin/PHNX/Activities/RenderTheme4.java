...
import de.htw.berlin.PHNX.Activities.MapBaseActivity;
 ...
 */
public class RenderTheme4 extends MapBaseActivity implements XmlRenderThemeMenuCallback {
	...
	protected XmlRenderTheme getRenderTheme() {
		try {
			...
			Log.e(MapApplication.TAG, "Render theme failure " + e.toString());
		}
		return null;
	}
	...
	public Set<String> getCategories(XmlRenderThemeStyleMenu menuStyle) {
		...
		if (baseLayer == null) {
			Log.w(MapApplication.TAG, "Invalid style " + id);
			return null;
		}
